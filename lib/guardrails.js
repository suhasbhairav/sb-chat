export const GUARDED_SYSTEM_PROMPT = `You are SB AI Chat, a careful and useful AI assistant.
...
export const DEFAULT_SYSTEM_PROMPT = "You are SB AI Chat, a helpful AI assistant.";
