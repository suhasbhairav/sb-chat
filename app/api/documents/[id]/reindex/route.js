...
export async function POST(request, { params }) {
  ...
  try {
    ...
    const settings = {
      ...
      ...embeddingSettings,
      vectorStoreProvider,
      ollamaBaseUrl: String(payload.ollamaBaseUrl || store.settings.ollamaBaseUrl || process.env.OLLAMA_BASE_URL || process.env.BATUK_OLLAMA_BASE_URL || "http://localhost:11434"),
    ...
    const nextDocument = {
      ...
      ollamaBaseUrl: ["ollama", "llamaindex-ollama"].includes(resolvedSettings.embeddingProvider) ? resolvedSettings.ollamaBaseUrl : null,
